document.addEventListener('DOMContentLoaded', () => {
    ...
    // Lógica para el contador de la oferta en la página de inicio
    ...
    if(countdownElement) {
        ...
        const timer = setInterval(function() {
            ...
            if (distance < 0) {
                ...
                const ofertaWhatsappBtn = document.getElementById('oferta-whatsapp-btn');
                if(ofertaWhatsappBtn) {
                    ofertaWhatsappBtn.style.display = 'none';
                }
            }
        }, 1000);
    }
